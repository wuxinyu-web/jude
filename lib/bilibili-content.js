...
(()=>{
  ...
  chrome.runtime.onMessage.addListener((m,_sender,reply)=>{
    ...
    if(m.action==='getCurrentTime'){reply({currentTime:Number(v?.currentTime)||0,paused:v?.paused??true,videoId:YTD_PLATFORM.videoIdFromUrl(location.href)});return false;}

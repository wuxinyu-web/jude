...
var YTD_PLATFORM = (() => {
  ...
  function parse(url){
    try{const u=new URL(url);if(u.protocol!=='https:')return null;
      if(['www.bilibili.com','m.bilibili.com'].includes(u.hostname)){
  ...
  function supported(url){try{const u=new URL(url);return u.protocol==='https:'&&['www.youtube.com','m.youtube.com','www.bilibili.com','m.bilibili.com'].includes(u.hostname);}catch{return false;}}
